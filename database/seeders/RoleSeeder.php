...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.reservas.index', 'description' => 'Ver mis reservas'])->syncRoles([$role1, $role5]);
        Permission::create(['name' => 'admin.reservas.create', 'description' => 'Crear un reserva'])->syncRoles([$role1, $role5]);
        ...
        Permission::create(['name' => 'admin.notificaciones.show', 'description' => 'Ver Notificaciones'])->syncRoles([$role1, $role2, $role5]);
