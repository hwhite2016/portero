        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="form-group"> <!-- Fecha de Nacimiento -->
                    ...
                    <div class="input-group date" id="personafechanacimiento" data-target-input="nearest">
                        {!! Form::text('personafechanacimiento', null, array('data-toggle' => 'datetimepicker','data-target' => '#personafechanacimiento', 'class' => 'form-control datetimepicker-input')) !!}
                        <div class="input-group-append" data-target="#personafechanacimiento" data-toggle="datetimepicker">
...
<script>
    $(function () {
      ...
      $('#personafechanacimiento').datetimepicker({
           format: 'L',
           format: 'YYYY/MM/DD'
      });
