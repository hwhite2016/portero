...
<div class="card card-primary">
    ...
    <div class="card-header bg-primary">
        <h1 class="card-title">EDITAR CIUDAD</h1>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <div class="form-group"> <!-- Pais -->
            {{ Form::label('paisid', 'Pais') }}
            {!! Form::select('paisid', $paises, $ciudad->paisid, ['class' => 'form-control  select2','style'=>'width: 100%','data-placeholder'=>'Seleccione un pais']) !!}
        </div>
