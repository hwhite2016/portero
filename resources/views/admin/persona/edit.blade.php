...
@section('content_header')
    {{-- <h1 class="ml-3">Editar Persona</h1> --}}
@stop
...
<div class="card card-primary">
    ...
    <div class="card-header bg-primary">
        <h1 class="card-title">EDITAR PERSONA</h1>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <div class="form-group"> <!-- Conjunto -->
            {{ Form::label('conjuntoid', 'Copropiedad') }}
			{!! Form::select('conjuntos[]', $conjuntos, null, ['class' => 'form-control select2', 'multiple'=>'multiple', 'data-placeholder'=>'Seleccione los conjuntos a administrar', 'data-width'=>'100%']) !!}
            @error('conjuntos')
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-8 col-sm-10"><a href="{{route('admin.personas.index')}}">Volver al listado de personas</a></div>
