<div class="row">
    <div class="col-12">
        <a href="#" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#mascotasModal" data-whatever="{{$registro->unidadid}}">
            <i class="fas fa-plus-circle"></i> &nbsp Agregar mascota
        </a>
    </div>
                ...
                <tr>
                  ...
                  <td>
                      {{-- @can('admin.mascotas.destroy') --}}
                        {!! Form::model($mascota, ['route'=>['registros.destroyMascota', $mascota->id], 'method'=>'delete', 'class'=>'frm_delete']) !!}
                        @csrf
...
<!-- Modal -->
{!! Form::open(['route'=>'registros.storeMascota', 'method'=>'post']) !!}
    @csrf
