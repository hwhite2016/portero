<div class="row">
    <div class="col-12">
        <a href="#" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#vehiculosModal" data-whatever="{{$registro->unidadid}}">
            <i class="fas fa-plus-circle"></i> &nbsp Agregar vehiculo
        </a>
    </div>
                ...
                <tr>
                  ...
                  <td>
                      {{-- @can('admin.vehiculos.destroy') --}}
                        {!! Form::model($vehiculo, ['route'=>['registros.destroyVehiculo', $vehiculo->id], 'method'=>'delete', 'class'=>'frm_delete']) !!}
                        @csrf
...
<!-- Modal -->
{!! Form::open(['route'=>'registros.storeVehiculo', 'method'=>'post']) !!}
    @csrf
